...
uv pip install --reinstall --python-platform x86_64-manylinux2014 --python-version 3.12 --only-binary :all: --target .build/lambda --requirements .build/requirements.txt
